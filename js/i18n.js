...
export const i18n = {
  EN:{
    ...
    invalidAmount:'Enter a valid amount greater than zero.', invalidEmail:'Invalid email format.', acceptTermsRequired:'You must agree to the Platform Rules and Privacy Policy.',
    ...
    acceptTermsText:'I agree to the', platformRules:'Platform Rules', andText:'and', privacyPolicy:'Privacy Policy',
    ...
    // Dashboard
    guest:'Guest', welcomeGuestTitle:'Welcome to Lolanceizi premium!', welcomeGuestDesc:'Browse tasks and features without limits. Sign up to start earning.', dashMotivation:'Today you are suspiciously ahead of schedule.', dashMotivationDesc:'Complete one more task to boost your streak, wallet, and rank.',
    ...
    you:'You',
    // Landing — hero
    heroBadge:'🔥 Not your boring task platform', heroLine1:'Memes. Videos. Code.', heroLine2:'All in one place.', heroSubtitle:'Lolanceizi is where short videos, cringe memes, hilarious photos, and real web coding projects live together. Create content, complete tasks, earn crypto — and have fun doing it.',
    ...
    // Landing — features
    featuresTitle:'Why Lolanceizi is different',
    ...
    jackpot:'Jackpot', epicWin:'Epic Win', rareWin:'Rare Win', multiplier:'multiplier', andMore:'and up to',
    // Price Prediction
  ...
  UA:{
    ...
    invalidAmount:'Введи суму більше нуля.', invalidEmail:'Email некоректний.', acceptTermsRequired:'Потрібно погодитись з Правилами платформи та Політикою приватності.',
    ...
    acceptTermsText:'Я погоджуюсь з', platformRules:'Правилами платформи', andText:'та', privacyPolicy:'Політикою приватності',
    ...
    guest:'Гість', welcomeGuestTitle:'Вітаємо на Lolanceizi преміум!', welcomeGuestDesc:'Переглядайте задачі та функції без обмежень. Зареєструйтеся щоб розпочати заробляти.', dashMotivation:'Сьогодні ви попереду графіку.', dashMotivationDesc:'Виконайте ще одну задачу щоб підвищити серію, баланс і рейтинг.',
    ...
    you:'Ти',
    // Landing — герой
    heroBadge:'🔥 Ми не такі як всі', heroLine1:'Меми. Відео. Код.', heroLine2:'Все в одному місці.', heroSubtitle:'Lolanceizi — це місце де короткі відео, кринжові меми, смішні фото і справжні веб-проекти живуть разом. Створюй контент, виконуй задачі, заробляй крипту — і отримуй задоволення.',
    ...
    // Landing — фічі
    featuresTitle:'Чому Lolanceizi інший',
    ...
    jackpot:'Джекпот', epicWin:'Епічний виграш', rareWin:'Рідкісний виграш', multiplier:'множник', andMore:'і до',
    // Прогноз ціни
  ...
  DE:{
    ...
    invalidAmount:'Bitte geben Sie einen Betrag größer als Null ein.', invalidEmail:'Ungültiges E-Mail-Format.', acceptTermsRequired:'Sie müssen den Plattformregeln und der Datenschutzrichtlinie zustimmen.',
    ...
    guest:'Gast', welcomeGuestTitle:'Willkommen bei Lolanceizi Premium!', welcomeGuestDesc:'Aufgaben und Funktionen ohne Einschränkungen durchsuchen.', dashMotivation:'Heute sind Sie dem Zeitplan voraus.', dashMotivationDesc:'Erledigen Sie eine weitere Aufgabe für Ihren Streak.',
    ...
    you:'Sie',
    // Landing
    heroBadge:'🔥 Nicht eure langweilige Plattform', heroLine1:'Memes. Videos. Code.', heroLine2:'Alles an einem Ort.', heroSubtitle:'Lolanceizi ist der Ort wo Kurzvideos, Cringe-Memes, lustige Fotos und echte Web-Projekte zusammenleben. Erstelle Content, erledige Aufgaben, verdiene Krypto — und hab Spaß dabei.',
    ...
    featuresTitle:'Warum Lolanceizi anders ist',
    ...
    jackpot:'Jackpot', epicWin:'Epischer Gewinn', rareWin:'Seltener Gewinn', multiplier:'Multiplikator', andMore:'und bis zu',
  ...
  FR:{
    ...
    invalidAmount:'Veuillez entrer un montant supérieur à zéro.', invalidEmail:'Format d\'email invalide.', acceptTermsRequired:'Vous devez accepter les Règles de la plateforme et la Politique de confidentialité.',
    ...
    acceptTermsText:'J\'accepte les', platformRules:'Règles de la plateforme', andText:'et la', privacyPolicy:'Politique de confidentialité',
    ...
    guest:'Invité', welcomeGuestTitle:'Bienvenue sur Lolanceizi Premium !', welcomeGuestDesc:'Parcourez les tâches et fonctions sans limites.', dashMotivation:'Aujourd\'hui vous êtes en avance.', dashMotivationDesc:'Complétez une tâche pour booster votre série.',
    ...
    featuresTitle:'Pourquoi Lolanceizi est différent',
    ...
    jackpot:'Jackpot', epicWin:'Gain épique', rareWin:'Gain rare', multiplier:'multiplicateur', andMore:'et jusqu\'à',
  ...
  ES:{
    ...
    invalidAmount:'Ingresa un monto mayor que cero.', invalidEmail:'Formato de email inválido.', acceptTermsRequired:'Debes aceptar las Reglas de la plataforma y la Política de privacidad.',
    ...
    acceptTermsText:'Acepto las', platformRules:'Reglas de la plataforma', andText:'y la', privacyPolicy:'Política de privacidad',
    ...
    guest:'Invitado', welcomeGuestTitle:'¡Bienvenido a Lolanceizi Premium!', welcomeGuestDesc:'Explora tareas y funciones sin límites.', dashMotivation:'Hoy vas adelantado.', dashMotivationDesc:'Completa una tarea más para aumentar tu racha.',
    ...
    you:'Tú',
    heroBadge:'🔥 No somos tu plataforma aburrida', heroLine1:'Memes. Videos. Código.', heroLine2:'Todo en un solo lugar.', heroSubtitle:'Lolanceizi es donde los videos cortos, los memes cringe, las fotos divertidas y los proyectos web reales conviven. Crea contenido, completa tareas, gana crypto — y diviértete haciéndolo.',
    ...
    featuresTitle:'Por qué Lolanceizi es diferente',
    ...
    jackpot:'Jackpot', epicWin:'Ganancia épica', rareWin:'Ganancia rara', multiplier:'multiplicador', andMore:'y hasta',
  ...
  PL:{
    ...
    invalidAmount:'Wpisz kwotę większą niż zero.', invalidEmail:'Nieprawidłowy format e-mail.', acceptTermsRequired:'Musisz zaakceptować Regulamin platformy i Politykę prywatności.',
    ...
    acceptTermsText:'Akceptuję', platformRules:'Regulamin platformy', andText:'oraz', privacyPolicy:'Politykę prywatności',
    ...
    guest:'Gość', welcomeGuestTitle:'Witaj w Lolanceizi Premium!', welcomeGuestDesc:'Przeglądaj zadania i funkcje bez ograniczeń.', dashMotivation:'Dziś jesteś przed harmonogramem.', dashMotivationDesc:'Wykonaj kolejne zadanie dla serii.',
    ...
    you:'Ty',
    heroBadge:'🔥 Nie jesteśmy nudną platformą', heroLine1:'Memy. Filmy. Kod.', heroLine2:'Wszystko w jednym miejscu.', heroSubtitle:'Lolanceizi to miejsce gdzie krótkie filmy, cringe memy, śmieszne zdjęcia i prawdziwe projekty webowe żyją razem. Twórz content, wykonuj zadania, zarabiaj krypto — i baw się przy tym.',
    ...
    featuresTitle:'Dlaczego Lolanceizi jest inny',
    ...
    jackpot:'Jackpot', epicWin:'Epicki wygrany', rareWin:'Rzadki wygrany', multiplier:'mnożnik', andMore:'i do',
