...
export const i18n = {
  EN:{
    ...
    // Landing — manifesto
    manifestoTitle:'We are NOT like everyone else', manifestoText:'Forget boring freelance platforms. We mix entertainment with real work. Post memes, share cringe, build web projects, take tasks — all while earning coins and climbing the leaderboard. This is a platform for creators who know that work can be fun.',
    ...
    feat6Title:'Crypto Wallet', feat6Desc:'Buy coins with USDT, earn from tasks, tip other users. Your balance is always at your fingertips.',
    ...
    earnStep:'Earn Rewards', earnStepDesc:'Complete tasks and earn coins to your wallet',
    // Landing — CTA & footer
    ...
    faqQ1:'How do I earn coins?', faqA1:'Complete tasks, post in the feed, check in daily, and play mini-games. Each activity rewards coins and XP.',
    ...
    faqQ4:'Can I withdraw my coins?', faqA4:'Coins can be spent on room passes, point packs, tips to other users, and more features coming soon.',
    ...
    tasksPageDesc:'Browse and take on tasks to earn coins. Higher levels unlock harder tasks with bigger rewards.',
  ...
  UA:{
    ...
    // Landing — маніфест
    manifestoTitle:'Ми НЕ такі як всі', manifestoText:'Забудь нудні фріланс-платформи. Ми поєднуємо розваги зі справжньою роботою. Постиш меми, ділишся кринжем, будуєш веб-проекти, береш задачі — і все це заробляючи монети та піднімаючись у рейтингу. Це платформа для креаторів, які знають що робота може бути кайфовою.',
    ...
    feat6Title:'Крипто-гаманець', feat6Desc:'Купуй монети за USDT, заробляй на задачах, надсилай чайові. Твій баланс завжди під рукою.',
    ...
    earnStep:'Заробляй нагороди', earnStepDesc:'Виконуй задачі й отримуй монети на гаманець',
    // Landing — CTA і футер
    ...
    faqQ1:'Як заробити монети?', faqA1:'Виконуйте задачі, публікуйте пости, заходьте щодня та грайте в міні-ігри.',
    ...
    faqQ4:'Чи можу я вивести монети?', faqA4:'Монети можна витратити на пропуски кімнат, пакети очок, чайові іншим та інше.',
    ...
    tasksPageDesc:'Переглядайте та беріть задачі, щоб заробляти монети.',
  ...
  DE:{
    ...
    manifestoTitle:'Wir sind NICHT wie alle anderen', manifestoText:'Vergiss langweilige Freelance-Plattformen. Wir mischen Unterhaltung mit echter Arbeit. Poste Memes, teile Cringe, baue Web-Projekte, nimm Aufgaben an — und verdiene dabei Coins und steige im Ranking auf.',
    ...
    feat6Title:'Krypto-Wallet', feat6Desc:'Kaufe Coins mit USDT, verdiene durch Aufgaben, sende Trinkgeld. Dein Guthaben immer griffbereit.',
    ...
    earnStep:'Belohnungen verdienen', earnStepDesc:'Erledige Aufgaben und verdiene Coins auf dein Wallet',
    ...
    faqQ1:'Wie verdiene ich Münzen?', faqA1:'Erledige Aufgaben, poste im Feed, melde dich täglich an und spiele Minispiele.',
    ...
    faqQ4:'Kann ich meine Münzen abheben?', faqA4:'Münzen können für Raum-Pässe, Punktepakete, Trinkgelder und weitere Funktionen ausgegeben werden.',
    ...
    tasksPageDesc:'Durchsuche Aufgaben und verdiene Münzen. Höhere Level = größere Belohnungen.',
  ...
  FR:{
    ...
    manifestoTitle:'Nous ne sommes PAS comme les autres', manifestoText:'Oubliez les plateformes freelance ennuyeuses. On mélange le divertissement avec le vrai travail. Postez des mèmes, partagez du cringe, construisez des projets web, prenez des tâches — tout en gagnant des coins et en montant dans le classement.',
    ...
    feat6Title:'Portefeuille Crypto', feat6Desc:'Achetez des coins avec USDT, gagnez via les tâches, envoyez des pourboires. Votre solde toujours à portée de main.',
    ...
    earnStep:'Gagner des Récompenses', earnStepDesc:'Complétez des tâches et gagnez des coins dans votre portefeuille',
    ...
    faqQ1:'Comment gagner des pièces ?', faqA1:'Accomplissez des tâches, publiez dans le fil, connectez-vous quotidiennement et jouez à des mini-jeux.',
    ...
    faqQ4:'Puis-je retirer mes pièces ?', faqA4:'Les pièces peuvent être dépensées pour des passes de salon, packs de points, pourboires et plus encore.',
    ...
    tasksPageDesc:'Parcourez les tâches et gagnez des pièces. Niveaux supérieurs = meilleures récompenses.',
  ...
  ES:{
    ...
    manifestoTitle:'NO somos como todos los demás', manifestoText:'Olvida las plataformas freelance aburridas. Mezclamos entretenimiento con trabajo real. Publica memes, comparte cringe, construye proyectos web, toma tareas — todo mientras ganas monedas y subes en el ranking.',
    ...
    feat6Title:'Billetera Crypto', feat6Desc:'Compra monedas con USDT, gana con tareas, envía propinas. Tu saldo siempre a mano.',
    ...
    earnStep:'Gana Recompensas', earnStepDesc:'Completa tareas y gana monedas en tu billetera',
    ...
    faqQ1:'¿Cómo gano monedas?', faqA1:'Completa tareas, publica en el feed, regístrate diariamente y juega minijuegos.',
    ...
    faqQ4:'¿Puedo retirar mis monedas?', faqA4:'Las monedas se pueden gastar en pases de sala, packs de puntos, propinas y más funciones próximamente.',
    ...
    tasksPageDesc:'Explora tareas y gana monedas. Niveles más altos = mejores recompensas.',
  ...
  PL:{
    ...
    manifestoTitle:'NIE jesteśmy jak wszyscy inni', manifestoText:'Zapomnij o nudnych platformach freelancerskich. Łączymy rozrywkę z prawdziwą pracą. Postuj memy, dziel się cringe, buduj projekty webowe, bierz zadania — a przy tym zarabiaj coiny i wspinaj się w rankingu.',
    ...
    feat6Title:'Portfel Krypto', feat6Desc:'Kupuj coiny za USDT, zarabiaj na zadaniach, wysyłaj napiwki. Twoje saldo zawsze pod ręką.',
    ...
    earnStep:'Zarabiaj Nagrody', earnStepDesc:'Wykonuj zadania i zarabiaj coiny do portfela',
    ...
    faqQ1:'Jak zarabiać monety?', faqA1:'Wykonuj zadania, publikuj posty, loguj się codziennie i graj w mini-gry.',
    ...
    faqQ4:'Czy mogę wypłacić monety?', faqA4:'Monety można wydać na przepustki do pokojów, pakiety punktów, napiwki i więcej.',
    ...
    tasksPageDesc:'Przeglądaj zadania i zarabiaj monety. Wyższe poziomy = lepsze nagrody.',
